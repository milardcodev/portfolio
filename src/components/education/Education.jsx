...
const Education = () => {
    ...
    useEffect(() => {
        ...
        srBottom.reveal('.education-title', {});
  ...
  return (
    <section className="education section" id="education">
        <h2 className="section__title education-title">Education</h2>
        <span className="section__subtitle education-subtitle">My Personal Journey</span>
            ...
            <div className="education__sections">
                <div className={toggleState === 1 ? "education__content education__content-active"
                    ...
                    <div className="education__data">
                        <div>
                            <h3 className="education__title tertiary-title">University</h3>
                            <span className="education__subtitle tertiary-subtitle">Bachelors Degree</span>
                    ...
                    <div className="education__data">
                        ...
                        <div>
                            <h3 className="education__title secondary-title">High School</h3>
                            <span className="education__subtitle secondary-subtitle">Course</span>
                    ...
                    <div className="education__data">
                        <div>
                            <h3 className="education__title primary-title">Elementary School</h3>
                            <span className="education__subtitle"></span>
                            <div className="education__calendar primary-calendar">
                ...
                <div className={toggleState === 2 ? "education__content education__content-active"
                    ...
                    <div className="education__data">
                        <div>
                            <h3 className="education__title">Competition Title</h3>
                            <span className="education__subtitle">University</span>
                            <span className="education__place">Place</span>
